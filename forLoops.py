...
new_prices = [new - 5 for new in prices if new > 0]
print(new_prices)
...
print("Cuts under 30 dollar: " + str(cuts_under_30))


# 1.
# Carly wants to be able to market her low prices. 
# We want to find out what the average price of a cut is.
...
# Use a list comprehension to make a list called new_prices, which has each element 
# in prices minus 5.
